...
const Login = () => {
  ...
  return (
    ...
    <form onSubmit ={onSubmitHandler} className = 'relative bg-white p-10 rounded-xl text-slate-500'>
        ...
        <button className = 'bg-blue-600 w-full text-white py-2 rounded-full'> {state=== 'Login' ? state : 'Create account'} </button>
        {state === 'Login' ?
        <p className = 'mt-5 text-center'> No account? <span className = 'text-blue-600 cursor-pointer' onClick = {()=> setState('Sign Up')}>Sign Up</span></p>
        :
